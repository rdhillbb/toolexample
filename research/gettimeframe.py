...
"""
print(get_current_timeframe("year"))            # Expected to return the current year in yyyy format
print(get_current_timeframe("this month"))      # Invalid input, expected to return today's date and error message
print(get_current_timeframe("300 days ago"))    # Expected to return the date 300 days ago from today in mm/dd/yyyy format
print(get_current_timeframe("invalid input"))   # Invalid input, expected to return today's date and error message
print(get_current_timeframe("current/today"))  # Expected to return the current date in mm/dd/yyyy format
print(get_current_timeframe("lastyear"))       # Expected to return the date one year ago from today in mm/dd/yyyy format
print(get_current_timeframe("2 years ago"))    # Expected to return the date two years ago from today in mm/dd/yyyy format
print(get_current_timeframe("month"))          # Expected to return the current month and year in mm/yyyy format
print(get_current_timeframe("10 days ago"))    # Expected to return the date 10 days ago from today in mm/dd/yyyy format
print(get_current_timeframe("100 days ago"))   # Expected to return the date 100 days ago from today in mm/dd/yyyy format
print(get_current_timeframe("year"))           # Expected to return the current year in yyyy format
print(get_current_timeframe("this year"))      # Expected to return the current year in yyyy format
print(get_current_timeframe("invalid input"))  # Expected to return "Invalid input."
"""
